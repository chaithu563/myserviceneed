System.register(["./app.component", "./core/header/header", "./core/topmenu/topmenu", "./core/userview/userview", "./core/userview/user/registeruser", "./core/userview/user/edituser", "./core/userview/postservice/postservice", "./core/userview/servicesearch/servicesearch", "./core/userview/default/default", "./core/userview/findwork/findwork", "./core/userview/findwork/listviewwork/listviewwork", "./core/userview/findwork/mapviewwork/mapviewwork", "./core/userview/postservice/address/address", "./core/userview/postservice/serviceinfo/serviceinfo", "./core/userview/postservice/servicetime/servicetime", "./core/userview/postservice/userverify/userverify", "./shared/directives/googleplace.directive", "./shared/components/facebooklogin", "ng2-file-upload"], function (exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var app_component_1, header_1, topmenu_1, userview_1, registeruser_1, edituser_1, postservice_1, servicesearch_1, default_1, findwork_1, listviewwork_1, mapviewwork_1, address_1, serviceinfo_1, servicetime_1, userverify_1, googleplace_directive_1, facebooklogin_1, ng2_file_upload_1, myComponents, myDirectives, myPipes;
    return {
        setters: [
        ...
        execute: function () {
            ...
            exports_1("myComponents", myComponents = [
                ...
                serviceinfo_1.ServiceInfoComponent, servicetime_1.ServiceTimeComponent, userverify_1.UserVerifyComponent, facebooklogin_1.FacebookLoginComponent,
