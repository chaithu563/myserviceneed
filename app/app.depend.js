System.register(['./app.component', './core/header/header', './core/leftmenu/leftmenu', './core/userview/userview', './core/userview/user/registeruser', './core/userview/user/edituser'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var app_component_1, header_1, leftmenu_1, userview_1, registeruser_1, edituser_1;
    ...
    return {
        ...
        execute: function() {
            ...
            exports_1("myComponents", myComponents = [
                header_1.HeaderComponent, leftmenu_1.LeftMenuComponent, userview_1.UserViewComponent, app_component_1.AppComponent, registeruser_1.RegisterUserComponent, edituser_1.EditUserComponent
            ]);
